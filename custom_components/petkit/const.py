...
LIGHT_BRIGHTNESS_NAMED = {1: "low", 2: "medium", 3: "high"}

WF_MODE_OPTIONS = ["normal", "smart"]

WF_MODE_NAMED = {1: "normal", 2: "smart"}

WF_MODE_COMMAND = {FountainCommand.NORMAL: "normal", FountainCommand.SMART: "smart"}
...
PURIFIER_MODE_NAMED = {0: "auto", 1: "silent", 2: "standard", 3: "strong"}
...
LITTER_BOXES = {"t3": "PURA X", "t4": "PURA MAX", "t6": "Purobot Ultra"}
...
LITTER_TYPE_NAMED = {1: "bentonite", 2: "tofu", 3: "mixed"}
